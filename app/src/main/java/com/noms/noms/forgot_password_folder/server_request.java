...
public class server_request {
    ...
    public class SR_AsyncTask extends AsyncTask<Void, Void, String> {
        ...
        com.noms.noms.forgot_password_folder.callback callback;

        public SR_AsyncTask(String file_name, ArrayList<String> key, ArrayList<String> value, com.noms.noms.forgot_password_folder.callback callback) {
